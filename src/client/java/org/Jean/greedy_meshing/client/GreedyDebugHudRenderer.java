...
public final class GreedyDebugHudRenderer {
    ...
    public static void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        if (!GreedyConfig.debugTrianglesHud()) {
            return;
        }
        ...
        if (!runtimeActive) {
            guiGraphics.drawString(mc.font, "Reason: " + GreedyRuntimeState.inactiveReason(), x, y + lineHeight * 3, statusColor, true);
        }
        int metricsStart = runtimeActive ? 3 : 4;
